#include "FHS_GameplayTags.h"

// ---------------------------------------------------------------------------------------------------------------------

UE_DEFINE_GAMEPLAY_TAG(TAG_Status, TEXT("Status"))
UE_DEFINE_GAMEPLAY_TAG(TAG_Status_Stunned, TEXT("Status.Stunned"))
...
UE_DEFINE_GAMEPLAY_TAG(TAG_Status_AbilityCancelable, TEXT("Status.AbilityCancelable"));
...
UE_DEFINE_GAMEPLAY_TAG(TAG_Name_Ability, TEXT("Name.Ability"))
